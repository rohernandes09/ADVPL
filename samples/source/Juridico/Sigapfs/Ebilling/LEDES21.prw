...
Geração de arquivos E-billing XML nas versões 2.1
...
Local aFatPag        := JurGetDados('NXA', 1, xFilial('NXA') + cCodEsc + cFatura, {'NXA_CMOEDA','NXA_CLIPG','NXA_LOJPG','NXA_CCLIEN','NXA_CLOJA' })
	...
	If TRBPRIN->(!Eof())
		...
		Aadd(aArqXml,"<ledesxmlebilling2.1 xmlns='http://www.ledes.org/LEDES21.xsd'>")
		...
		If aRet[1]
			Aadd(aArqXml,Space(3)+"</firm>")
			Aadd(aArqXml,"</ledesxmlebilling2.1>")
