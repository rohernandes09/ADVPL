...
Local aFldRel		:= {"RA_NOME", 'RA_RG', 'RA_CIC'}
Local lBlqAcesso	:= aOfusca[2] .And. !Empty( FwProtectedDataUtil():UsrNoAccessFieldsInList( aFldRel ) )

If lBlqAcesso
	//"Dados Protegidos- Acesso Restrito: Este usuแrio nใo possui permissใo de acesso aos dados dessa rotina. Saiba mais em {link documenta็ใo centralizadora}"
	...
	If fClose( nHdl )
		...
		Else
			If fErase( cNomeArq ) == 0
				MsgAlert( 'Nใo existem registros a serem gravados. A gera็ใo do arquivo ' + AllTrim( AllTrim( cNomeArq ) ) + ' foi abortada.')
			Else
...
GeraBDN0()
If cNum == 'NAOEXISTE'
	MsgAlert( 'Parโmetro ES_SEQBDN nใo encontrado. Gentiliza criแ-lo no configurador com o tipo caracter. Descri็ใo: "Ultimo Sequencial do Arquivo BDN referente ao recibo de pagamento eletr๔nico." Valor padrใo: 000000000')
	BREAK
Elseif Empty(cNum) .And. !lEhIncBDN
	MsgAlert( 'Ao selecionar "Substitui็ใo", ้ obrigat๓rio o preenchimento do campo Num.Lote Orig.')
	BREAK
EndIf
...
If cNum <> 'NAOEXISTE' .And. !Empty(cNum)
	nSeq_++
