...
Else // Layout Impressão Prefeitura / Municipio / Provedor
	...
	oDanfse:Say(nLinea, 350, "Regime de Apuração Tibutária pelo SN", oFont07N:oFont)
	nLinea := nLinea+nLiDados 
	oDanfse:Say(nLinea, 002, SUBSTR(IIF(Type("XXXXXXXXXX") <> "U","XXXXXXXXXX","-"),1,nMxCol12), oFont07:oFont) //Simples Nacional na Data de competência
	oDanfse:Say(nLinea, 350, SUBSTR(IIF(Type("XXXXXXXXXX") <> "U","XXXXXXXXXX","-"),1,nMxCol32), oFont07:oFont) //Regime de Apuração Tibutária pelo SN
